...
<body>
    ...
    <div class="d-flex justify-content-between navbar navbar-expand-lg navbar navbar-dark bg-dark">
        <nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
            ...
            <ul class=" navbar-nav">
                ...
                {if isset($Administrador)}
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="tablaAdmin"> Tabla Administradores</a></li>
                {/if}
                {if !isset($nombre) && !isset($Administrador)}
        ...
        {/if}
         {if isset($Administrador)} 
        <div class= "nombreLogin">
            <h6 class= "loginIngresado"> Hola Admin: {$Administrador}</h6>
            <a href="logout"><button type="button" class="btn btn-danger btn-sm">Log Out</button></a>
        </div>
        {/if}
        {/if}
