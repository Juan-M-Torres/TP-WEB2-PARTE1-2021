<footer class="d-flex justify-content-between bg-dark">
        <div>
            <h4 class="link-light">Redes sociales</h4>
        ...
        <div>
            <h4 class="link-light">Medios de envio</h4>
        ...
        <div>
            <h4 class="link-light">Medios de pago</h4>
